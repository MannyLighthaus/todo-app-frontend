...
// if there is a todo item, move the createButton to the bottom of the page, hide the notodo icon and start incomplete content from the top of the page, not from the middle
// if (todos.length > 0) {
...
function renderTodos(todos) {
  ...
  todos.forEach((todo) => {
    ...
    checkbox.addEventListener("change", () => {
      ...
      todo.state = checkbox.checked ? 0 : 1; // 0 = Completed, 1 = Incomplete
