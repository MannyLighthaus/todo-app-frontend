...
const API_URL = "https://todo-app-backend-t85n.onrender.com"; // my backend URL.. where my data is fetched from

// FETCH ALL TODOS FROM B.E
async function fetchTodos() {
  try {
    const response = await fetch(API_URL / api / todos); // a GET request to the B.E API to retrieve the list.
