...
const API_BASE_URL = "https://todo-app-backend-t85n.onrender.com";
// FETCH ALL TODOS FROM B.E
async function fetchTodos() {
  try {
    const response = await fetch(`${API_BASE_URL}/todos`); // a GET request to the B.E API to retrieve the list.
