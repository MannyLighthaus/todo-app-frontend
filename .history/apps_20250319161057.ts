...
const categoriesIconsDivElement = document.querySelector(".categories-icons") as HTMLElement;

// getting the input text element by its class
const textFieldElement = document.querySelector(".new-text") as HTMLElement;

// getting the input date element by its class
const dateFieldElement = document.querySelector(".date") as HTMLElement;

//getting the input text element by its class
const timeFieldElement = document.querySelector(".time") as HTMLElement;

// getting the text area element by its class
const textAreaElement = document.querySelector(".note") as HTMLElement;
...
const backButton = document.querySelector(".back-btn-container") aas HTMLButtonElement;
